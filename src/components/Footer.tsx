...
export default function Footer() {
    ...
    return (
      <footer className="border-t border-neutral-900 bg-black py-12 w-full px-6 md:px-16 lg:px-24 print:hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 font-sans font-medium gap-4">
          <span>&copy; {new Date().getFullYear()} Sovereign Millionaires. All Rights Reserved.</span>
          <div className="flex gap-4 font-mono">
            ...
            <a href="#" className="text-slate-400 hover:text-white transition-colors">Privacy Registry</a>
          </div>
        </div>
      </footer>
    );
  ...
  return (
    <footer className="border-t border-neutral-900 bg-[#000000] py-16 w-full px-6 md:px-16 lg:px-24 print:hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 font-sans text-slate-400">
        <div>
          <div className="flex items-center gap-2 mb-4">
            <img src="/smlogo.png" alt="Sovereign Millionaires Logo" className="w-6 h-6 object-contain" />
            <span className="font-heading text-white tracking-widest text-xs uppercase font-bold">
        ...
        <div className="text-xs leading-relaxed font-medium text-slate-400">
          <h5 className="font-heading text-white uppercase tracking-widest mb-4 font-bold">Rules & Guidelines</h5>
          <p className="text-xs text-slate-400 mb-2">Subject to local business and financial regulations.</p>
          <p className="text-xs text-slate-400">REMY Tools and IDAR business blueprints are registered trademarks of Sovereign Millionaires.</p>
        </div>

        <div className="text-xs font-medium text-slate-400">
          <h5 className="font-heading text-white uppercase tracking-widest mb-4 text-left md:text-right font-bold">Contact Hub</h5>
          <p className="text-xs text-slate-400 text-left md:text-right">Nairobi, Kenya / Dubai, UAE</p>
          <p className="text-xs text-slate-400 text-left md:text-right mt-1">support@sovereignmillionaires.com</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-neutral-900 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 font-sans font-medium">
        ...
        <div className="flex gap-4 mt-4 md:mt-0 font-mono">
          <a href="#" className="hover:text-white transition-colors">Local Guidelines</a>
          <a href="#" className="hover:text-white transition-colors">Data Protection Act</a>
